...
## Disclaimer
  ...
  P8UnitCheck is  _not_ intended to compete with PHPUnit or other projects.
...
- Eliminate <code>echo, print*, var_</code>* etc. from code -> ship  _all output_ to <code>P8UnitCheck\Frontend\\*</code>
...
- Adding features:
  ...
  - attributing checks as _not complete_ (--> neither failed nor successfull)
  - attributing checks as _leapable_ on conditions (e.g: ext pgsql is not available)
